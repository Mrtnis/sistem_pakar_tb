	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav nav ml-auto">
	          ...
	          <li class="nav-item"><a href="#doctor-section" class="nav-link"><span>Penyakit TB Paru</span></a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-10 pt-5 ftco-animate">
          	<div class="mt-5">
	            <h1 class="mb-4">Selamat Datang <br>di Sistem Pakar TB Paru</h1>
    			...
    			<div class="col-md-12 col-lg-12 pl-lg-12 py-md-12">
    				<div class="py-md-5">
			          ...
			          <div class="col-md-12 heading-section ftco-animate p-4 p-lg-5">
			            <h2 class="mb-4">Sistem Pakar <span>TB Paru</span></h2>
			            ...
			            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Recusandae hic porro autem aut ea expedita, consectetur veritatis blanditiis odio qui mollitia in dolores minus nulla non ipsam a officia explicabo sed distinctio eveniet excepturi impedit, quo ipsum? Eligendi nobis blanditiis ratione cum porro ullam, aspernatur error libero, esse ab quibusdam.</p>
			            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis illo, culpa iusto molestias sit totam harum aperiam. Sapiente vel amet ipsum a? Quas nesciunt vel, esse ducimus ipsum corrupti optio!</p>
			          </div>
			        </div>
				</div>
	        </div>
		...
		<div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section text-center ftco-animate">
            <h2 class="mb-4">Gejala Penyakit TB Paru</h2>
    					...
    					<div class="col-md-4">
    						<div class="department-wrap p-4 ftco-animate">
    							<div class="text p-2 text-center">
									...
									<h3><a href="#">Batuk Berdarah</a></h3>
									<p>Batuk selalu mengeluarkan darah kurang lebih sebulan</p>
    							</div>
    						</div>
    						<div class="department-wrap p-4 ftco-animate">
    							<div class="text p-2 text-center">
    								...
    								<h3><a href="#">Dada Terasa Nyeri</a></h3>
    						...
    						<div class="department-wrap p-4 ftco-animate">
    							<div class="text p-2 text-center">
    								...
    								<h3><a href="#">Berat Badan Turun</a></h3>
    								<p>Far far away, behind the word mountains</p>
    							</div>
    						</div>
    					</div>
    					...
    					<div class="col-md-4">
    						<div class="department-wrap p-4 ftco-animate">
    							<div class="text p-2 text-center">
									...
									<h3><a href="#">Demam Tinggi</a></h3>
									<p>Suhu badan sangat tinggi, tidak seperti biasanya </p>
    							</div>
    						</div>
    						<div class="department-wrap p-4 ftco-animate">
    							<div class="text p-2 text-center">
    					...
    					<div class="col-md-4">
    						<div class="department-wrap p-4 ftco-animate">
    							<div class="text p-2 text-center">
    								...
    								<h3><a href="#">Keringat Dingin</a></h3>
    								<p>Mengeluarkan keringat dingin pada malam hari</p>
    							</div>
    						</div>
    						<div class="department-wrap p-4 ftco-animate">
    							<div class="text p-2 text-center">
    								...
    								<h3><a href="#">Nafsu Makan Berkurang</a></h3>
    								<p>Far far away, behind the word mountains</p>
    							</div>
    						</div>
    					</div>
			...
			<div class="container">
				<div class="row d-flex align-items-center">
					<div class="col-md-5 heading-section heading-section-white">
						...
						<h2 class="mb-4">Penyakit TB Paru di Indonesia</h2>
					</div>
					<div class="col-md-7">
						<div class="row pt-4">
