...
<html lang="en">
  ...
  <body>  
        ...
        <div class="container mt-4">
            ...
            <div class="kopSurat">
                <img src="images/puskesmas.png" width="200px" position="fixed" style="margin-left:55px">
                <h1 style="margin-top:-170px; margin-bottom:140px; margin-left:255px; font-size:50px;" position="fixed">PUSKESMAS KUTABLANG</h1>
                <h3 style="margin-top:-130px; margin-bottom:90px; margin-left:260px; font-size:13px;">Jl. Banda Aceh-Medan Km. 500 Desa Krueng Panjo Kecamatan Kutablang, Bireuen, Aceh, Indonesia</h3>
            </div>
            <hr>
            ...
            <div class="row">
                <div style="margin-left:25%" class="mb-4 mt-4">
                    <h3 class="text-center font-weight-bold">Kartu Tanda Pengecekan Gejala <br> Penyakit TB Paru</h3>
                    <hr>
                </div>
